...
if(isset($_GET[type]))
{
$results = mysql_query("select * from products where product_type='$_GET[type]' ORDER BY prod_id DESC  LIMIT 0 , 9");	
}
else
{
$results = mysql_query("select * from products ORDER BY prod_id DESC  LIMIT 0 , 9");	
}
			$i=0;
			while($ros = mysql_fetch_array($results))
			{
				if($ros['image']=="")
				{
